...
<body class="main-layout">
            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Call Us : +91 8082336680</a> </li>
                     </ul>
                  </div>
                  <div class="col-md-4 col-sm-4 ">
                     <a class="logo" href="#"><img src="images/lol.png" alt="#" /></a>
                  </div>
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> agrimdhotra02@gmail.com</a> </li>
                     </ul>
                  </div>
               </div>
            </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="service.php">PROJECTS</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="team.php">EDUCATION </a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="client.php">CARRER GOALS</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="contact.php"> SOFTWARE PROFICIENCY </a>
						      <li class="nav-item">
                                 <a class="nav-link" href="documents.php"> Document </a>
                           </ul>
                        </div>
                     </nav>
                  </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-7 col-lg-7">
               <div class="text-bg">
                  <h1>AGRIM <br>DHOTRA</h1>
                  <span>MY COMPLETE PROFILE FROM MY PROJECTS TO PROFICIENCY</span>
               </div>
            </div>
   ...
   <div id="service" class="service">
      <div class="container">
         <div class="row">
            <div class="col-md-7">
               <div class="titlepage">MY INFO</h2>
         ...
         <div class="row">
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  ...
                  <h3>STRENGTHS</h3>
                  <p>ADDAPTIVE,FLEXIBLE,HARD WORKING,QUICK LEARNER </p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  ...
                  <h3>INTERNSHIPS</h3>
                  <p>WEB DEV(DESIGN) AT SAY TECHNOLOGY,JAMMU</p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  ...
                  <h3>PROJECTS</h3>
                  <p>CREATED OWN WEBSITE www.agvulcan.in</p>
				  <p>HELPED IN DESIGNING(GOVT DRUGS AND FOOD CONTROL WEBSITE)</p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  ...
                  <h3>EDUCATION</h3>
				  <p>BE(CSE) MIET,JAMMU</p>
				  <p>BSF SCHOOL,JAMMU 12TH(2019)</p>
                  <p> BSF SCHOOL,JAMMU 10TH(2017)</p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
   ...
   <footer>
      <div class="footer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
			   <a class="logo" href="#"><img src="images/lol.png" ;alt="#"  height="200" width="400"/></a>
               </div>
               <div class="col-lg-5 col-md-6 col-sm-6">
                  <h3>Contact Us</h3>
                  <ul class="location_icon">
                     <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i></a> JAMMU
                        <br>INDIA
                     </li>
                     <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>agrimdhotra02@gmail</li>
                     <li><a href="#"><i class="fa fa-volume-control-phone" aria-hidden="true"></i></a>+91 8082336680</li>
                  </ul>
               ...
               <div class="col-lg-2 col-md-6 col-sm-6">
                  ...
                  <ul class="link_icon">
                     ...
                     <li>
                        <a href="about.html">
                           </i> <a href="documents.php"> Documents</li>
                     <li> <a href="certicates.php"> </i>Certificates</a></li>
                  </ul>
               </div>
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>© 2022 All Rights Reserved.<a href="">@AGVULCAN</a></p>
                  </div>
               </div>
            </div>
         </div>
